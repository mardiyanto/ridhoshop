...
<table id='style1' class='table table-striped table-bordered table-hover'>
					...
					<tbody>";
$kategori=mysql_query("SELECT  * FROM kota ORDER BY id_kota DESC");
while ($d=mysql_fetch_array($kategori)){
$no++;
...
<h1 class='page-header'>
Data Orders              </h1>
 <a href='javascript:history.go(-1)' ><button type='button' class='btn btn-warning'>KEMBALI</button></a><br />
<br />
<div class='row'>
		  ...
		  <tr><td>Keterangan</td><td><textarea name='Ket' style='width: 260px; height: 150px;'>$r[Ket]</textarea></td></tr>
...
echo "
    ...
    <tr>
      ...
      <td align='right'><strong>Rp.$ongkoskirim1_rp</strong></td>
    </tr>
    <tr>
...
echo"
    ...
    <tr>
      <td colspan='4'>Ongkos Kirim</td>
      <td align='right'><strong>Rp.0</strong></td>
    </tr>
    <tr>
      <td colspan='4'>Grand Total</td>
      <td align='right'><b>Rp.$total_rp</b></td>
