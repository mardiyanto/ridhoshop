...
mysql_query("UPDATE kustomer SET nama_lengkap='$nama',alamat='$_POST[ALM]',kd_pos='$_POST[KD]', telpon='$_POST[HP]',id_kota='$_POST[kota]' WHERE id_kustomer='$_SESSION[kustomer]'");
...
mysql_query("INSERT INTO orders(tgl_order,jam_order,id_kustomer,id_kota_o,m_pengiriman,m_pembayaran,id_bank_o) 
